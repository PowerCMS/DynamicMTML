<?php
function smarty_block_mtdynamicmtml( $args, $content, $ctx, $repeat ) {
        ...
        if ( $build_type == 'rebuild_static' ) {
            ...
            if ( $id ) {
                ...
                if ( file_exists( $template ) ) {
                    ...
                    $begin = '<?php $this->_tag_stack[] = array(\'mtdynamicmtml\', array(\'id\' => "mt:dynamicmtml"';
                    $begin = preg_quote( $begin, '/' );
                    $end = '<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_mtdynamicmtml';
                    $end = preg_quote( $end, '/' );
